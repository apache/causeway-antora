...
* *xref:gsguide:ROOT:about.adoc[Getting Started Guide]*
* *xref:conguide:ROOT:about.adoc[Contributor' Guide]*
...
** xref:comguide:ROOT:cutting-a-release.adoc[Cutting a Release]
** xref:comguide:ROOT:verifying-releases.adoc[Verifying a Release]
